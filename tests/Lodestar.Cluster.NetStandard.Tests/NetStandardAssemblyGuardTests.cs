...
/// </summary>
/// <remarks>
/// Without this, a reference that quietly resolved back to net10.0 would leave every
/// test passing while proving nothing. One fact rather than several: this package
/// depends on no other <c>Lodestar.*</c> assembly (#529).
/// </remarks>
public sealed class NetStandardAssemblyGuardTests
{
    ...
    {
        Assembly assembly = typeof(KMeans).Assembly;
