...
internal static class PackagingGate
{
    ...
    private static readonly Dictionary<string, string> Excluded = new(StringComparer.Ordinal)
    {
        ...
        ["Lodestar.Stats.Regression.Instrumental.IvFirstStage..ctor"] = ResultRecordCtor,
        ["Lodestar.Stats.Regression.Instrumental.IvSummary..ctor"] = ResultRecordCtor,
        ["Lodestar.Stats.Regression.WaldTest..ctor"] = ResultRecordCtor,
        ["Lodestar.Stats.Regression.Panel.PanelSummary..ctor"] = ResultRecordCtor,
