...
/// <summary>The link a <c>GeneralizedLinearModel</c> maps its linear predictor to the mean through.</summary>
/// <remarks>
/// A second axis beside <c>GlmFamily</c>, chosen on <c>GlmOptions.Link</c>. Not every family takes
