...
/// <summary>The response distribution a <c>GeneralizedLinearModel</c> fits, with the link statsmodels defaults it to.</summary>
/// <remarks>
...
public enum GlmFamily
{
    ...
    /// <remarks>
    /// <c>α</c> is given rather than estimated, through <c>GlmOptions.NegativeBinomialAlpha</c>. The log
    ...
    /// <remarks>
    /// The inverse link by default, as statsmodels', or the log link through <c>GlmOptions.Link</c>. The
    /// first family here whose dispersion <c>φ</c> is estimated, as Pearson's χ² over the residual degrees of
    /// freedom, and reported on <c>GlmSummary.Dispersion</c>.
    /// </remarks>
    Gamma = 3,
}
