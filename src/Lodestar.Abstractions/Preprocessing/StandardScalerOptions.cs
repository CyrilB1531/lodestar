...
/// <summary>Which of the two standardisation steps <c>StandardScaler</c> applies.</summary>
/// <remarks>
...
/// <c>StandardScaler.Transform</c> does <em>and</em> which fitted statistics exist —
/// see the remarks on <c>StandardScaler.Fit</c>, which are the reference's, not this
/// package's invention.
/// </remarks>
