...
/// <summary>How many quantiles <see cref="QuantileTransformer"/> fits, and what it maps onto.</summary>
/// <remarks>
...
/// <summary>Which distribution <see cref="QuantileTransformer"/> maps its ranks onto.</summary>
