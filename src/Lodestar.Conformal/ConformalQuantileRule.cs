...
/// <summary>Which order statistic <see cref="SplitConformal.Quantile(ReadOnlySpan{double}, double, ConformalQuantileRule)"/> reads.</summary>
/// <remarks>
...
/// is the zero value, so a <c>default</c> keeps the rule decision 0070 established (#866).
/// </remarks>
