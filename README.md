...
| `Lodestar.Cluster` | ML.NET k-means, NumFlat | **Not measured.** ML.NET clusters inside an `IDataView` pipeline, and NumFlat ships `net8.0` only; neither has been run against `KMeans.Fit` |
