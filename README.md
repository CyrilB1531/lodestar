...
| [`Lodestar.Survival`](src/Lodestar.Survival/README.md) | core | Kaplan-Meier, Nelson-Aalen, the log-rank family, the concordance index and Cox regression, at lifelines parity |
