...
| `GLS`, cluster-robust covariances | ⚠️ **gap** — decision 0115 puts GLS after the GLM families ([#771](https://github.com/CyrilB1531/lodestar/issues/771)); cluster-robust is unscoped |
