...
<!-- nightly-baseline: 9f9406c5b886c83d62bb9e18ea4a73d891564409 -->
<!-- nightly-owed: AddedTokenScanBenchmarks BertNormalizerBenchmarks BitParallelEditDistanceBenchmarks ChainedProductBenchmarks ClassificationReportBenchmarks ClassifierCurveBenchmarks CorrelationBenchmarks CoxBenchmarks DecompositionWidthBenchmarks DistributionTailBenchmarks EmbeddingSearchHelpersBenchmarks GlmBenchmarks GlmNegativeBinomialBenchmarks GlmOffsetBenchmarks GlmPoissonBenchmarks GlsBenchmarks HacClusterBenchmarks HouseholderQrBenchmarks KolmogorovDurbinBenchmarks KsAutoBenchmarks KsExactTableBenchmarks LeastSquaresRoutingBenchmarks MannWhitneyExactBenchmarks MetaNumericsStatsBenchmarks MultiClassRocAucBenchmarks MultilabelConfusionMatrixBenchmarks MultinomialLogitBenchmarks OlsBenchmarks PartitionValidityBenchmarks PrecompiledNormalizerBenchmarks QuantileBenchmarks RankTestBenchmarks RankingMetricsBenchmarks RobustCovarianceBenchmarks SerialCorrelationBenchmarks StationarityBenchmarks StatsBenchmarks SurvivalBenchmarks TiledCosineTopKBenchmarks TiledMinHashSignaturesBenchmarks TiledSparseDenseProductBenchmarks VarianceAndFitBenchmarks VectorAutoregressionBenchmarks WeightedLeastSquaresBenchmarks -->
...
- Commit: `9f9406c5b886c83d62bb9e18ea4a73d891564409`
- Previous run: `9f9406c5b886c83d62bb9e18ea4a73d891564409`
...
- `TransformerIncumbentBenchmarks`
...
**New tonight: 3.** Each of these had not moved on its previous reading.

| class | parameters | method | kind | tonight | against | change | threshold |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| `MyersGateBenchmarks` | Band=64 | `Kernel` | drift | 0.07 | 0.05 | +40% | 20% |
| `LcsGateBenchmarks` | Band=18 | `Dp_Cjk` | step | 0.67 | 0.99 | -32% | 30% |
| `SimilaritySketchBenchmarks` | Documents=2000, Permutations=64 | `FingerprintsOnly` | drift | 0.04 | 0.04 | +25% | 20% |

**Still away from their median: 48.** These moved on an earlier run, and their median has not caught up yet.

| class | parameters | method | kind | tonight | against | change | threshold |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| `MetricsIncumbentBenchmarks` | Samples=100000, Request=AccuracyAlone | `MlNet` | drift | 3440.52 | 133.83 | +2471% | 20% |
| `MetricsIncumbentBenchmarks` | Samples=1000000, Request=AccuracyAlone | `MlNet` | drift | 2030.61 | 85.09 | +2286% | 20% |
| `FuzzIncumbentBenchmarks` | Operation=PartialRatio | `FuzzySharp` | drift | 13.2 | 0.89 | +1383% | 20% |
| `TokenizerIncumbentBenchmarks` | Model=SentencePiece | `MlTokenizers` | drift | 1.19 | 0.15 | +693% | 20% |
| `TokenizerIncumbentBenchmarks` | Model=WordPiece | `MlTokenizers` | drift | 2.48 | 0.85 | +202% | 20% |
| `FuzzIncumbentBenchmarks` | Operation=WRatio | `FuzzySharp` | drift | 4.12 | 2.13 | +100% | 20% |
| `IndelBenchmarks` | Length=512 | `Distance_CodePoint` | drift | 1.01 | 44.42 | -98% | 20% |
| `IndelBenchmarks` | Length=128 | `Distance_CodePoint` | drift | 1 | 23.2 | -96% | 20% |
| `FuzzBenchmarks` | — | `PartialRatio` | drift | 7.01 | 115.57 | -94% | 20% |
| `IndelBenchmarks` | Length=32 | `Distance_CodePoint` | drift | 1.09 | 16.61 | -93% | 20% |
| `IndelBenchmarks` | Length=24 | `Distance_CodePoint` | drift | 1.12 | 12.94 | -91% | 20% |
| `PartialFitBenchmarks` | RowCount=100000, BatchCount=10 | `SparseFit` | step | 0.49 | 0.275 | +78% | 30% |
| `IndelBenchmarks` | Length=20 | `Distance_CodePoint` | drift | 1.25 | 5.22 | -76% | 20% |
| `IndelBenchmarks` | Length=12 | `Distance_CodePoint` | drift | 1.3 | 5.26 | -76% | 20% |
| `PartialFitBenchmarks` | RowCount=100000, BatchCount=100 | `SparseFit` | step | 0.48 | 0.275 | +75% | 30% |
| `IndelBenchmarks` | Length=16 | `Distance_CodePoint` | drift | 1.35 | 5.3 | -74% | 20% |
| `IndelBenchmarks` | Length=8 | `Distance_CodePoint` | drift | 1.39 | 4.82 | -72% | 20% |
| `BpeBenchmarks` | — | `Bpe` | drift | 2.77 | 1.74 | +59% | 20% |
| `PartialFitBenchmarks` | RowCount=10000, BatchCount=10 | `SparseFit` | step | 0.19 | 0.12 | +58% | 30% |
| `VectorizerIncumbentBenchmarks` | Documents=1000 | `MlNet` | drift | 21.84 | 12.89 | +56% | 20% |
| `FuzzBenchmarks` | — | `WRatio` | drift | 10.79 | 23.38 | -54% | 20% |
| `DecompositionBenchmarks` | — | `MlNet_ProjectToPrincipalComponents_Rank20` | drift | 1.35 | 0.85 | +53% | 20% |
| `PartialFitBenchmarks` | RowCount=10000, BatchCount=100 | `SparseFit` | step | 0.19 | 0.125 | +52% | 30% |
| `LcsGateBenchmarks` | Band=96 | `Kernel` | drift | 0.03 | 0.06 | -50% | 20% |
| `PartialFitBenchmarks` | RowCount=10000, BatchCount=10 | `DenseFitOfTheSameData` | step | 1.39 | 0.96 | +45% | 30% |
| `PartialFitBenchmarks` | RowCount=100000, BatchCount=100 | `DenseFitOfTheSameData` | step | 1.38 | 0.955 | +45% | 30% |
| `LevenshteinIncumbentBenchmarks` | Length=512 | `Fastenshtein` | drift | 39.76 | 27.97 | +42% | 20% |
| `MyersGateBenchmarks` | Band=96 | `Kernel` | drift | 0.07 | 0.1 | -40% | 20% |
| `BatchEmbeddingBenchmarks` | CorpusSize=128 | `EmbedBatchBucketed` | drift | 0.33 | 0.51 | -39% | 20% |
| `VectorizerIncumbentBenchmarks` | Documents=200 | `MlNet` | drift | 10.02 | 7.26 | +38% | 20% |
| `BatchEmbeddingBenchmarks` | CorpusSize=32 | `EmbedBatchBucketed` | drift | 0.33 | 0.53 | -38% | 20% |
| `MetricsIncumbentBenchmarks` | Samples=100000, Request=Bundle | `MlNet` | drift | 5.43 | 3.99 | +36% | 20% |
| `BatchEmbeddingBenchmarks` | CorpusSize=8 | `EmbedBatch` | drift | 0.39 | 0.61 | -36% | 20% |
| `PartialFitBenchmarks` | RowCount=100000, BatchCount=10 | `DenseFitOfTheSameData` | step | 1.39 | 1.035 | +34% | 30% |
| `BatchEmbeddingBenchmarks` | CorpusSize=32 | `EmbedBatch` | drift | 0.38 | 0.57 | -33% | 20% |
| `PartialFitBenchmarks` | RowCount=10000, BatchCount=100 | `DenseFitOfTheSameData` | step | 1.39 | 1.045 | +33% | 30% |
| `BatchEmbeddingBenchmarks` | CorpusSize=8 | `EmbedBatchBucketed` | drift | 0.39 | 0.58 | -33% | 20% |
| `LevenshteinCodePointBenchmarks` | Length=128, Distinct=512 | `Distance_Utf16` | drift | 2.8 | 2.11 | +33% | 20% |
| `LcsGateBenchmarks` | Band=18 | `Kernel_Cjk` | drift | 0.19 | 0.28 | -32% | 20% |
| `BatchEmbeddingBenchmarks` | CorpusSize=128 | `EmbedBatch` | drift | 0.39 | 0.54 | -30% | 20% |
| `LcsGateBenchmarks` | Band=18 | `Kernel` | drift | 0.12 | 0.17 | -29% | 20% |
| `LevenshteinCodePointBenchmarks` | Length=128, Distinct=32 | `Distance_Utf16` | drift | 2.76 | 2.14 | +29% | 20% |
| `MyersGateBenchmarks` | Band=64 | `Kernel_Cjk` | drift | 0.09 | 0.07 | +29% | 20% |
| `FuzzBenchmarks` | — | `TokenSortRatio` | drift | 8.18 | 11.3 | -28% | 20% |
| `FuzzBenchmarks` | — | `TokenSetRatio` | drift | 8.53 | 11.67 | -27% | 20% |
| `DecompositionBenchmarks` | — | `Nmf_Rank20` | drift | 6.21 | 7.07 | -21% | 20% |
| `LevenshteinIncumbentBenchmarks` | Length=512 | `F23_StringSimilarity` | drift | 59.43 | 49.57 | +21% | 20% |
| `LevenshteinCodePointBenchmarks` | Length=512, Distinct=32 | `Distance_Utf16` | drift | 4.18 | 3.43 | +20% | 20% |
