...
<!-- nightly-baseline: a5f400484df38ca0ec04247446d4e85df7013528 -->
<!-- nightly-owed: BitParallelEditDistanceBenchmarks ChainedProductBenchmarks CoxBenchmarks GlmBenchmarks GlmNegativeBinomialBenchmarks GlmOffsetBenchmarks GlmPoissonBenchmarks HacClusterBenchmarks KolmogorovDurbinBenchmarks KsExactTableBenchmarks MannWhitneyExactBenchmarks MultinomialLogitBenchmarks RobustCovarianceBenchmarks SurvivalBenchmarks TiledCosineTopKBenchmarks TiledMinHashSignaturesBenchmarks TiledSparseDenseProductBenchmarks VectorAutoregressionBenchmarks -->
...
- Commit: `a5f400484df38ca0ec04247446d4e85df7013528`
- Previous run: `a5f400484df38ca0ec04247446d4e85df7013528`
...
**New tonight: 15.** Each of these had not moved on its previous reading.

| class | parameters | method | kind | tonight | against | change | threshold |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| `Bm25Benchmarks` | Documents=20000 | `LuceneQuery` | step | 0.76 | 0.01 | +7500% | 30% |
| `Bm25Benchmarks` | Documents=20000 | `LuceneFromText` | step | 6082.04 | 106.7 | +5600% | 30% |
| `MetricsIncumbentBenchmarks` | Samples=1000000, Request=AccuracyAlone | `MlNet` | step | 2082.84 | 85.09 | +2348% | 30% |
| `Bm25Benchmarks` | Documents=20000 | `LodestarFromText` | step | 4835.22 | 207.6 | +2229% | 30% |
| `Bm25Benchmarks` | Documents=1000 | `LuceneFromText` | step | 3652.72 | 257.06 | +1321% | 30% |
| `Bm25Benchmarks` | Documents=1000 | `LuceneQuery` | step | 1.63 | 0.12 | +1258% | 30% |
| `Bm25Benchmarks` | Documents=1000 | `LodestarFromText` | step | 3817.02 | 505.13 | +656% | 30% |
| `FuzzIncumbentBenchmarks` | Operation=WRatio | `FuzzySharp` | step | 4.21 | 2.13 | +98% | 30% |
| `VectorizerIncumbentBenchmarks` | Documents=1000 | `MlNet` | step | 19.84 | 12.88 | +54% | 30% |
| `DecompositionBenchmarks` | — | `MlNet_ProjectToPrincipalComponents_Rank20` | step | 1.21 | 0.85 | +42% | 30% |
| `PrincipalComponentVarianceBenchmarks` | Shape=100x200 | `NumFlat_Pca` | step | 1.66 | 1.18 | +41% | 30% |
| `LevenshteinIncumbentBenchmarks` | Length=512 | `Fastenshtein` | step | 38.6 | 27.97 | +38% | 36% |
| `LcsGateBenchmarks` | Band=8 | `Kernel_Cjk` | step | 1.13 | 0.82 | +38% | 30% |
| `MetricsIncumbentBenchmarks` | Samples=100000, Request=Bundle | `MlNet` | drift | 5.51 | 4.17 | +26% | 20% |
| `FuzzBenchmarks` | — | `TokenSortRatio` | drift | 7.87 | 10.79 | -21% | 20% |

**Still away from their median: 24.** These moved on an earlier run, and their median has not caught up yet.

| class | parameters | method | kind | tonight | against | change | threshold |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| `MetricsIncumbentBenchmarks` | Samples=100000, Request=AccuracyAlone | `MlNet` | step | 3066.29 | 133.83 | +2191% | 121% |
| `FuzzIncumbentBenchmarks` | Operation=PartialRatio | `FuzzySharp` | drift | 13.03 | 0.85 | +1448% | 20% |
| `TokenizerIncumbentBenchmarks` | Model=SentencePiece | `MlTokenizers` | drift | 1.24 | 0.15 | +720% | 20% |
| `IndelBenchmarks` | Length=512 | `Distance_CodePoint` | step | 1.05 | 43.6 | -98% | 64% |
| `IndelBenchmarks` | Length=128 | `Distance_CodePoint` | step | 1.07 | 21.25 | -95% | 46% |
| `FuzzBenchmarks` | — | `PartialRatio` | drift | 6.95 | 117.71 | -94% | 20% |
| `IndelBenchmarks` | Length=32 | `Distance_CodePoint` | step | 1.06 | 12.92 | -92% | 46% |
| `IndelBenchmarks` | Length=24 | `Distance_CodePoint` | step | 1.06 | 12.16 | -91% | 71% |
| `TokenizerIncumbentBenchmarks` | Model=WordPiece | `MlTokenizers` | drift | 1.56 | 0.83 | +82% | 20% |
| `IndelBenchmarks` | Length=20 | `Distance_CodePoint` | step | 1.12 | 4.38 | -74% | 30% |
| `IndelBenchmarks` | Length=8 | `Distance_CodePoint` | step | 1.19 | 4.64 | -74% | 36% |
| `IndelBenchmarks` | Length=12 | `Distance_CodePoint` | step | 1.15 | 4.36 | -74% | 48% |
| `IndelBenchmarks` | Length=16 | `Distance_CodePoint` | step | 1.2 | 4.49 | -73% | 53% |
| `BpeBenchmarks` | — | `Bpe` | drift | 2.78 | 1.72 | +56% | 20% |
| `LcsGateBenchmarks` | Band=96 | `Kernel` | drift | 0.04 | 0.06 | -50% | 20% |
| `LevenshteinCodePointBenchmarks` | Length=128, Distinct=32 | `Distance_Utf16` | drift | 2.87 | 2.14 | +34% | 20% |
| `LevenshteinCodePointBenchmarks` | Length=128, Distinct=512 | `Distance_Utf16` | step | 2.84 | 2.14 | +33% | 30% |
| `MyersGateBenchmarks` | Band=96 | `Kernel` | drift | 0.07 | 0.1 | -30% | 20% |
| `MyersGateBenchmarks` | Band=64 | `Kernel_Cjk` | drift | 0.09 | 0.07 | +29% | 20% |
| `LcsGateBenchmarks` | Band=18 | `Kernel_Cjk` | drift | 0.22 | 0.28 | -25% | 20% |
| `LcsGateBenchmarks` | Band=48 | `Kernel` | drift | 0.05 | 0.04 | +25% | 20% |
| `LcsGateBenchmarks` | Band=18 | `Kernel` | drift | 0.13 | 0.17 | -24% | 20% |
| `LevenshteinCodePointBenchmarks` | Length=512, Distinct=32 | `Distance_Utf16` | drift | 4.05 | 3.41 | +23% | 20% |
| `LevenshteinIncumbentBenchmarks` | Length=64 | `F23_StringSimilarity` | drift | 29.17 | 37.22 | -22% | 20% |
