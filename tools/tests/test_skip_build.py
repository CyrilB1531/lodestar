...
@pytest.mark.parametrize("paths", [
    ...
    [".github/workflows/release-nuget-org.yaml"],
])
...
def test_a_rename_counts_both_of_its_names():
    ...
    assert TOOL.skip_build([".github/workflows/old.yml", "src/New.cs"]) is False
    assert TOOL.skip_build([".github/workflows/old.yml", ".github/workflows/new.yml"]) is True
...
@pytest.mark.parametrize("path", [
    "docs/a name with spaces.md",
    "docs/naïve.md",
    ".github/workflows/a name.yml",
])
