...
@pytest.mark.parametrize(
    ...
    [
        ...
        # A rename from one Markdown name to another lists both, and both are Markdown.
        (["docs/guides/new-name.md", "docs/guides/old-name.md"], True),
        # A deleted file is listed under its name like any other.
        (["docs/superpowers/specs/2026-09-01_0001_removed.md"], True),
        (["src/Lodestar.Stats/ShapiroWilk.cs", "CHANGELOG.md"], False),
        (["src/Lodestar.Stats/ShapiroWilk.cs"], False),
        # A workflow change has to run the workflow it changes, in full.
        ([".github/workflows/ci.yml"], False),
        (["docs/guides/performance.md", "README.md", "assets/diagram.svg"], False),
